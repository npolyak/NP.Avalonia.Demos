...
namespace LinuxControl
{
    ...
    static unsafe class __Gtk
    {
        ...
        [DllImport(GtkName)]
        public static extern void gtk_container_set_border_width(IntPtr container, uint border_width);
        ...
        [DllImport(GtkName)]
        public static extern IntPtr gtk_button_new_with_label(Utf8Buffer label);
